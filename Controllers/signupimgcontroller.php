<?php
  ...
  include 'c:/xampp/htdocs/websites/App1/Models/Uploadimg.php';  
...
if(!$authInstance->isloggedin()){
    $authInstance->redirect('../SIGNUP/signupview.php');
    exit();
}
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  //  $imagename=$_FILES['dpic'];
    ...
    //$dir="images/";
    $dir="c:/xampp/htdocs/websites/App1/Images/signup_img/dp--";
